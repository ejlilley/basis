For code relating to the [paper](https://ui.adsabs.harvard.edu/abs/2023A%26A...672A..91L/abstract) "A general basis set algorithm for galactic haloes and discs", see the [`basis` subdirectory](basis).
